...
class Kakao {
    constructor(code) {
        ...
        this.clientID = 'faf8536f6684556c4a15623c70a54698';
        this.clientSecret = '39unbvMrBxfi6UgANWTUu1GEIPaackDy';
        this.redirectUri = 'http://localhost:3000/auth/kakao/callback';
        this.code = code;

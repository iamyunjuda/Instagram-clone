...
│   ├── app              				# 앱에 대한 코드 작성
│ 	│   ├── User            			# User 도메인 폴더
│   │ 	│   ├── storyDao.js          	# User 관련 데이터베이스
│ 	│ 	│   ├── storyController.js 		# req, res 처리
│ 	│ 	│   ├── storyProvider.js   		# R에 해당하는 서버 로직 처리
│ 	│ 	│   ├── storyService.js   		# CUD에 해당하는 서버 로직 처리   
...
3. storyRoute.js, storyController.js, storyProvider.js, userDao.js를 구성하여 해당 테이블의 값들을 불러오는 로직을 만든다.
